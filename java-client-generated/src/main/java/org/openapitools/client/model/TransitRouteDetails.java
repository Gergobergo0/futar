...
import org.openapitools.client.model.TransitRouteVariant;
...
public class TransitRouteDetails {
  ...
  @javax.annotation.Nullable
  private List<TransitRouteVariant> variants = new ArrayList<>();
  ...
  public TransitRouteDetails() {
  }

  public TransitRouteDetails id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public TransitRouteDetails shortName(@javax.annotation.Nullable String shortName) {
  ...
  public TransitRouteDetails longName(@javax.annotation.Nullable String longName) {
  ...
  public TransitRouteDetails description(@javax.annotation.Nullable String description) {
  ...
  public TransitRouteDetails type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public TransitRouteDetails url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  @Deprecated
  public TransitRouteDetails color(@javax.annotation.Nullable String color) {
    this.color = color;
    return this;
  }
  ...
  @Deprecated
  public TransitRouteDetails textColor(@javax.annotation.Nullable String textColor) {
  ...
  public TransitRouteDetails agencyId(@javax.annotation.Nullable String agencyId) {
  ...
  @Deprecated
  public TransitRouteDetails iconDisplayType(@javax.annotation.Nullable String iconDisplayType) {
  ...
  @Deprecated
  public TransitRouteDetails iconDisplayText(@javax.annotation.Nullable String iconDisplayText) {
  ...
  public TransitRouteDetails bikesAllowed(@javax.annotation.Nullable Boolean bikesAllowed) {
  ...
  public TransitRouteDetails style(@javax.annotation.Nullable TransitRouteStyle style) {
    this.style = style;
    return this;
  }
  ...
  public TransitRouteDetails sortOrder(@javax.annotation.Nullable Integer sortOrder) {
  ...
  public TransitRouteDetails variants(@javax.annotation.Nullable List<TransitRouteVariant> variants) {
    this.variants = variants;
    return this;
  }

  public TransitRouteDetails addVariantsItem(TransitRouteVariant variantsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<TransitRouteVariant> getVariants() {
    return variants;
  }

  public void setVariants(@javax.annotation.Nullable List<TransitRouteVariant> variants) {
    this.variants = variants;
  }


  public TransitRouteDetails alertIds(@javax.annotation.Nullable List<String> alertIds) {
    this.alertIds = alertIds;
    return this;
  }

  public TransitRouteDetails addAlertIdsItem(String alertIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    TransitRouteDetails transitRouteDetails = (TransitRouteDetails) o;
    return Objects.equals(this.id, transitRouteDetails.id) &&
        Objects.equals(this.shortName, transitRouteDetails.shortName) &&
        Objects.equals(this.longName, transitRouteDetails.longName) &&
        Objects.equals(this.description, transitRouteDetails.description) &&
        Objects.equals(this.type, transitRouteDetails.type) &&
        Objects.equals(this.url, transitRouteDetails.url) &&
        Objects.equals(this.color, transitRouteDetails.color) &&
        Objects.equals(this.textColor, transitRouteDetails.textColor) &&
        Objects.equals(this.agencyId, transitRouteDetails.agencyId) &&
        Objects.equals(this.iconDisplayType, transitRouteDetails.iconDisplayType) &&
        Objects.equals(this.iconDisplayText, transitRouteDetails.iconDisplayText) &&
        Objects.equals(this.bikesAllowed, transitRouteDetails.bikesAllowed) &&
        Objects.equals(this.style, transitRouteDetails.style) &&
        Objects.equals(this.sortOrder, transitRouteDetails.sortOrder) &&
        Objects.equals(this.variants, transitRouteDetails.variants) &&
        Objects.equals(this.alertIds, transitRouteDetails.alertIds);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, shortName, longName, description, type, url, color, textColor, agencyId, iconDisplayType, iconDisplayText, bikesAllowed, style, sortOrder, variants, alertIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransitRouteDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransitRouteDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransitRouteDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransitRouteDetails is not found in the empty JSON string", TransitRouteDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransitRouteDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransitRouteDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("variants") != null && !jsonObj.get("variants").isJsonNull()) {
        ...
        if (jsonArrayvariants != null) {
          ...
          for (int i = 0; i < jsonArrayvariants.size(); i++) {
            TransitRouteVariant.validateJsonElement(jsonArrayvariants.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransitRouteDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransitRouteDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransitRouteDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransitRouteDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<TransitRouteDetails>() {
           @Override
           public void write(JsonWriter out, TransitRouteDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransitRouteDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransitRouteDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransitRouteDetails
   * @throws IOException if the JSON string is invalid with respect to TransitRouteDetails
   */
  public static TransitRouteDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransitRouteDetails.class);
  }

  /**
   * Convert an instance of TransitRouteDetails to an JSON string
   *
   * @return JSON string
   */
